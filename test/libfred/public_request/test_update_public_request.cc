...
public:
    ...
    explicit PublicRequestAuthTypeFake(const std::string &_type):type_(_type) { }
    ~PublicRequestAuthTypeFake() { }
                                       ...
                                       PublicRequestAuthTypeFake
{
          ...
          public_request_type(*this)
    {
        ...
        BOOST_CHECK_EQUAL(dbres.size(), 1);//expecting existing system registrar
        ...
        BOOST_CHECK_EQUAL(dbres.size(), 1);//expecting existing public request type
...
BOOST_AUTO_TEST_CASE(public_request_lock_guard_by_id)
{
    ...
    catch (const ::LibFred::PublicRequestLockGuardById::Exception &e)
    {
        ...
        BOOST_CHECK_EQUAL(e.get_public_request_doesnt_exist(), bad_id);
...
BOOST_AUTO_TEST_CASE(public_request_lock_guard_by_identification)
{
    ...
    BOOST_CHECK_EQUAL(static_cast<const ::LibFred::LockedPublicRequest&>(locked).get_id(), create_result.public_request_id);
    try
    {
    ...
    {
        BOOST_CHECK(e.is_set_public_request_doesnt_exist());
        BOOST_CHECK_EQUAL(e.get_public_request_doesnt_exist(), bad_identification);
        BOOST_TEST_MESSAGE(boost::diagnostic_information(e));
        throw;
    }
    catch (const std::exception &e)
...
BOOST_AUTO_TEST_CASE(update_public_request_without_changes)
{
    ...
    catch (const ::LibFred::UpdatePublicRequest::Exception &e)
    {
        ...
        BOOST_CHECK_EQUAL(e.get_nothing_to_do(), create_result.public_request_id);
        BOOST_TEST_MESSAGE(boost::diagnostic_information(e));
        throw;
    }
    catch (const std::exception &e)
...
BOOST_AUTO_TEST_CASE(update_public_request_wrong_public_request_id)
{
    ...
    catch (const ::LibFred::UpdatePublicRequest::Exception &e)
    {
        ...
        BOOST_CHECK(!e.is_set_unknown_registrar_id());
        BOOST_CHECK(!e.is_set_bad_public_request_status());
        BOOST_CHECK_EQUAL(e.get_public_request_doesnt_exist(), bad_public_request_id);
        BOOST_TEST_MESSAGE(boost::diagnostic_information(e));
        throw;
    }
    catch (const std::exception &e)
...
BOOST_AUTO_TEST_CASE(update_public_request_wrong_email_or_registrar)
{
    ...
    catch (const ::LibFred::UpdatePublicRequest::Exception &e)
    {
        ...
        BOOST_CHECK(!e.is_set_unknown_registrar_id());
        BOOST_CHECK(!e.is_set_bad_public_request_status());
        BOOST_CHECK_EQUAL(e.get_unknown_email_id(), bad_email_id);
        BOOST_TEST_MESSAGE(boost::diagnostic_information(e));
        throw;
    }
    catch (const std::exception &e)
    ...
    catch (const ::LibFred::UpdatePublicRequest::Exception &e)
    {
        ...
        BOOST_CHECK(!e.is_set_bad_public_request_status());
        BOOST_CHECK_EQUAL(e.get_unknown_email_id(), bad_email_id);
        BOOST_CHECK_EQUAL(e.get_unknown_registrar_id(), bad_registrar_id);
        BOOST_TEST_MESSAGE(boost::diagnostic_information(e));
        throw;
    }
    catch (const std::exception &e)
