...
class has_nsset_changed_authinfo : public has_nsset
{
private:
...
class has_nsset_removed_tech_c : public has_nsset
{
public:
...
class has_nsset_added_tech_c : public has_nsset
{
public:
    ...
    const std::set<std::string> email_addresses =
            {
                nsset_tech_c1_to_be_notified.notifyemail.get_value(),
                nsset_tech_c2_to_be_notified.notifyemail.get_value(),
                added_tech_c.notifyemail.get_value()
            };
    BOOST_CHECK(
        Notification::gather_email_addresses(
            ctx,
...
class has_nsset_changed_tech_c : public has_nsset
{
public:
...
BOOST_AUTO_TEST_SUITE_END()//TestNotifier/GatherEmailAddresses/Nsset/Update
