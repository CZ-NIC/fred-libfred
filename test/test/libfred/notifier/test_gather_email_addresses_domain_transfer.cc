          ...
          keyset(
                  Test::exec(
                          ::LibFred::CreateKeyset("KEYSET1", registrar.handle)
                              .set_tech_contacts(
                                      {keyset_tech_c1.handle, keyset_tech_c2.handle}),
                          ctx)),
          nsset_tech_c1(
                  Test::exec(
...
template <typename Tdomainoperation = ::LibFred::UpdateDomain>
struct has_domain_operation_followed_by_future_changes
{
...
BOOST_AUTO_TEST_SUITE_END()//TestNotifier/GatherEmailAddresses/Domain/Transfer
