...
BOOST_AUTO_TEST_CASE( test_correct_data )
{
    ...
    const unsigned long long message_id = ::LibFred::Poll::CreatePollMessage<::LibFred::Poll::MessageType::delete_domain>()
    ...
    BOOST_CHECK_EQUAL(static_cast<std::string>(message_res[0]["msgtype_name_"]),
                      Conversion::Enums::to_db_handle(::LibFred::Poll::MessageType::delete_domain));
