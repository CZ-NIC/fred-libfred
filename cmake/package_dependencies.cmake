    ...
    if("${__SRC_DIR}" STREQUAL "")
        ...
        elseif("${__METHOD}" STREQUAL "INCLUDE")
            if(NOT EXISTS "${__SRC_DIR}")
                message(FATAL_ERROR "no ${__SRC_DIR} directory found; ${dependency_upper_case}_DIR "
                                    "does not refer location of ${__DEPENDENCY}")
                return()
            endif()
        else()
...
macro(add_package_dependencies)
    ...
    foreach(LINE ${_LINES})
        ...
        set(${dependency_upper_case}_DIR "${CMAKE_CURRENT_SOURCE_DIR}/${_dependency_clone_path}" CACHE FILEPATH "Location of ${_dependency}")
...
function(provide_package_dependency_dist __DEPENDENCY)
    ...
    if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/.git AND GIT_PROGRAM)
        string(TOUPPER "${PACKAGE_NAME}" package_name_upper_case)
