...
#ifndef GET_STATE_HISTORY_IMPL_HH_3008DDEA9570619DEC7701D8D9B19A0E//date "+%s.%N"|md5sum|tr "[a-f]" "[A-F]"
#define GET_STATE_HISTORY_IMPL_HH_3008DDEA9570619DEC7701D8D9B19A0E
...
typename GetStateHistory<D, S>::Result GetStateHistory<D, S>::exec(
        ...
        const HistoryInterval& range)const
{
    ...
    typename Result::Record record_on_begin;
    struct StateAction
    {
        S state_begin;
        S state_end;
    };
    using StateChanges = std::map<typename Result::TimePoint, StateAction>;
    ...
    {
        const auto lower_limit = static_cast<typename Result::TimePoint>(dbres[0][1]);
...
template <typename D, typename S>
const D& GetStateHistory<D, S>::derived()const
{
...
#endif//GET_STATE_HISTORY_IMPL_HH_3008DDEA9570619DEC7701D8D9B19A0E
