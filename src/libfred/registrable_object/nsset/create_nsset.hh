...
*/
class CreateNsset : public Util::Printable<CreateNsset>
{
public:
    DECLARE_EXCEPTION_DATA(invalid_nsset_handle, std::string);/**< exception members for invalid nsset handle generated by macro @ref DECLARE_EXCEPTION_DATA*/
    ...
    */
    CreateNsset(const std::string& handle, const std::string& registrar);
    /**
    ...
    */
    Result exec(const OperationContext& ctx, const std::string& returned_timestamp_pg_time_zone_name = "Europe/Prague");
...
#endif//CREATE_NSSET_HH_85F3D80AEDC6465FB71D1306CCEADAEE
