...
namespace LibFred
{
     ...
     */
    static bool is_transfer_authorized(const OperationContext& _ctx, const unsigned long long _nsset_id, const std::string& _authinfopw_for_authorization) {
    ...
    unsigned long long TransferNsset::exec(const OperationContext& _ctx) {
