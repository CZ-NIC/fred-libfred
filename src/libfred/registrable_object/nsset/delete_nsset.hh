...
*/
class DeleteNssetByHandle : public Util::Printable<DeleteNssetByHandle>
{
public:
...
* In case of other insuperable failures and inconsistencies, an instance of @ref InternalError or other exception is thrown.
*/
class DeleteNssetById : public Util::Printable<DeleteNssetById>
{
public:
...
#endif//DELETE_NSSET_HH_032B916B940949C5B705A366FDCC1F0A
