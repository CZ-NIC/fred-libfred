...
*/
class CreateContact : public Util::Printable<CreateContact>
{
public:
    ...
    */
    CreateContact(const std::string& handle
            ...
            , const Optional< LibFred::ContactAddressList >& addresses
    ...
    * @return operation instance reference to allow method chaining
    */
    CreateContact& set_place(const LibFred::Contact::PlaceAddress &place);
    ...
    * @return operation instance reference to allow method chaining
    */
    CreateContact& set_addresses(const LibFred::ContactAddressList& addresses);
    ...
    */
    Result exec(const OperationContext& ctx, const std::string& returned_timestamp_pg_time_zone_name = "Europe/Prague")const;
...
private:
    ...
    Optional< LibFred::ContactAddressList > addresses_;/**< additional contact addresses */
...
#endif//CREATE_CONTACT_HH_99FAF02B7ADB45C3ADD9E9C3A0B9AFB7
