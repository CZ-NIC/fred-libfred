...
public:
    ...
    */
    std::string exec(const OperationContext& _ctx);
    ...
    */
    ...
    {};
private:
    void check_administrative_block_status_only(const OperationContext& _ctx) const;
    void check_server_blocked_status_absent(const OperationContext& _ctx) const;
