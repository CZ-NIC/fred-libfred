...
public:
    ...
    */
    CreateAdminObjectStateRestoreRequestId(
            ObjectId _object_id,
    ...
    */
    ...
    {};
private:
    ObjectStateId check_server_blocked_status_present(const OperationContext& _ctx) const;
...
#endif//CREATE_ADMIN_OBJECT_STATE_RESTORE_REQUEST_ID_HH_947011DB1B2D497386C1E425C1051C04
