...
public:
    ...
    */
    CreateObjectStateRequestId(ObjectId _object_id, const StatusList& _status_list);
    ...
    */
    std::pair<std::string, unsigned long long> exec(const OperationContext& _ctx);
...
#endif//CREATE_OBJECT_STATE_REQUEST_ID_HH_C78B357E78664A7A9D0916F9B2DA677A
