...
*/
class InfoRegistrarByHandle : public Util::Printable<InfoRegistrarByHandle>
{
public:
...
* In case of other unsuperable failures and inconstistencies, the instance of @ref InternalError or other exception is thrown.
*/
class InfoRegistrarById : public Util::Printable<InfoRegistrarById>
{
public:
...
#endif//INFO_REGISTRAR_HH_16ED9D26811B4BA49031C101C68DBD48
