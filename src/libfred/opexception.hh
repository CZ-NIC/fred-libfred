 ...
 */
class ExceptionStack : public virtual boost::exception
{
public:
    /**
    ...
    */
    void add_exception_stack_info(const std::string& info)
    {
        ...
        const std::string* const ptr = this->get_data_ptr();
        if (ptr != nullptr)
        {
            operation_stack_info += *ptr;
        }
    ...
    {
        const std::string* const data_ptr = this->get_data_ptr();
        return data_ptr != nullptr ? *data_ptr
                                   : std::string();
    }
    ...
    {
        return this->get_data_ptr() != nullptr;
    }
